describe('L.TileLayer.WMS.Format[\'application/vnd.ogc.gml\']', function () {
  ...
  describe('#toGeoJSON', function () {
    it('parses gml:MultiPolygon described by gml:coord elements with two coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by gml:coord elements with three coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
