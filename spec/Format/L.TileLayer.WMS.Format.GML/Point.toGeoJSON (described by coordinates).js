describe('L.TileLayer.WMS.Format[\'application/vnd.ogc.gml\']', function () {
  ...
  describe('#toGeoJSON', function () {
    it('parses gml:Point described by gml:coordinates element with two coordinates', function () {
      var responseText = '' +
        '<gml:Point>' +
        '  <gml:coordinates>' +
        '    1.0,2.0' +
    ...
    it('parses gml:Point described by gml:coordinates element with three coordinates', function () {
      var responseText = '' +
        '<gml:Point>' +
        '  <gml:coordinates>' +
        '    1.0,2.0,3.0' +
    ...
    it('parses gml:Point described by gml:coordinates element with custom separators', function () {
      var responseText = '' +
        '<gml:Point>' +
