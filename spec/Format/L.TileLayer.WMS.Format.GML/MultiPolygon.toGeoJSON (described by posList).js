describe('L.TileLayer.WMS.Format[\'application/vnd.ogc.gml\']', function () {
  ...
  describe('#toGeoJSON', function () {
    it('parses gml:MultiPolygon described by gml:posList elements with two coordinates', function () {
      ...
      '      <gml:innerBoundaryIs>' +
      '        <gml:LinearRing>' +
      '          <gml:posList  srsDimension="2">2 3 4 5 6 7 2 3</gml:posList>' +
      '        </gml:LinearRing>' +
      '      </gml:innerBoundaryIs>' +
      '      <gml:innerBoundaryIs>' +
      '        <gml:LinearRing>' +
      '          <gml:posList  srsDimension="2">3 4 5 6 7 8 3 4</gml:posList>' +
      '        </gml:LinearRing>' +
      '      </gml:innerBoundaryIs>' +
      '    </gml:Polygon>' +
      '  </gml:polygonMember>' +
    ...
    it('parses gml:MultiPolygon described by gml:posList elements with three coordinates', function () {
      ...
      '      <gml:outerBoundaryIs>' +
      '        <gml:LinearRing>' +
      '          <gml:posList srsDimension="3">1 2 2 3 4 2 5 6 2 1 2 2</gml:posList>' +
      '        </gml:LinearRing>' +
      '      </gml:outerBoundaryIs>' +
      '      <gml:innerBoundaryIs>' +
      '        <gml:LinearRing>' +
      '          <gml:posList  srsDimension="3">2 3 2 4 5 2 6 7 2 2 3 2</gml:posList>' +
      '        </gml:LinearRing>' +
      '      </gml:innerBoundaryIs>' +
      '      <gml:innerBoundaryIs>' +
      '        <gml:LinearRing>' +
      '          <gml:posList  srsDimension="3">3 4 2 5 6 2 7 8 2 3 4 2</gml:posList>' +
      '        </gml:LinearRing>' +
      '      </gml:innerBoundaryIs>' +
      '    </gml:Polygon>' +
      '  </gml:polygonMember>' +
