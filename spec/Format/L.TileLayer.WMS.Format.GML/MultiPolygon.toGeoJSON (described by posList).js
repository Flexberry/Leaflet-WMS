describe('L.TileLayer.WMS.Format[\'application/vnd.ogc.gml\']', function () {
  ...
  describe('#toGeoJSON', function () {
    it('parses gml:MultiPolygon described by gml:posList elements with two coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by gml:posList elements with three coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon(exterior) described by gml:posList elements with two coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by gml:posList(exterior) elements with three coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by gml:posList element with two coordinates & default srsDimension', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by gml:posList element with three coordinates & dimension equals to 3', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by single gml:polygonMember & gml:posList elements with two coordinates & default srsDimension', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by single gml:polygonMember gml:posList elements with three coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by single gml:polygonMember & gml:posList elements with two coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon described by single gml:polygonMember gml:posList elements with three coordinates & dimension equals to 3', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon(exterior) described by gml:posList element with two coordinates & default srsDimension', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon(exterior) described by gml:posList element with three coordinates & dimension equals to 3', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
    ...
    it('parses gml:MultiPolygon(exterior) described by single gml:polygonMember & gml:posList elements with two coordinates', function () {
      var responseText = '' +
      '<gml:MultiPolygon>' +
      '  <gml:polygonMember>' +
      '    <gml:Polygon>' +
